"""Tests for the specifier module + `kopi kanban specify` CLI surface.
...
from kopi_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `kopi kanban …` argparse surface directly."""
