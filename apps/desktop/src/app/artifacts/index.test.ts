...
import type { SessionInfo, SessionMessage } from '@/types/kopi'
...
describe('collectArtifactsForSession', () => {
  ...
  it('resolves remote image artifact thumbnails through the desktop fs bridge', async () => {
    ...
    expect(api).toHaveBeenCalledWith({
      path: '/api/fs/read-data-url?path=%2FUsers%2Fme%2F.kopi%2Fskills%2Fwork-esab%2Freferences%2Fimages%2Fmanual-step03.jpeg'
    })
  })
})
