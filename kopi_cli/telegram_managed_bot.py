...
DEFAULT_API_URL = "https://setup.kopi-ai-agent.nousresearch.com"
...
DEFAULT_BOT_NAME = "KOPI AI AGENT"
...
def generate_username_slug(length: int = 16) -> str:
    ...
    keeping ``kopi_<slug>_bot`` under Telegram's 32-character username limit.
    """
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``kopi_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"kopi_{generate_username_slug()}_bot"
