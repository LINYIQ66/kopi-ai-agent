...
| `OPENVIKING_AGENT` | `kopi` | Hermes peer ID in OpenViking, used for peer-scoped memories |
...
file URIs, such as
`viking://user/peers/kopi/memories/preferences/mem_abc123.md` or the canonical
`viking://user/default/peers/kopi/memories/preferences/mem_abc123.md`. Files
