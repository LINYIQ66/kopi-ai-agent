...
#
# Usage:
#   KOPI_UID=$(id -u) KOPI_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=hermes,kopi-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://kopi-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
