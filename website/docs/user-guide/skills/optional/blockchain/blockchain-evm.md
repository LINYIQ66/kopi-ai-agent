...
| | |
|---|---|
| Source | Optional — install with `kopi skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), KOPI AI AGENT |
| License | MIT |
...
Helper script path: `~/.kopi/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.kopi/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.kopi/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.kopi/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
