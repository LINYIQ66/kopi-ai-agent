"""Client for uploading ``kopi debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``kopi debug share``.
...
NAS_BASE = os.environ.get(
    "KOPI_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "kopi-ai-agent/debug-share"
