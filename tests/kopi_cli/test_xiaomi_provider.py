...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from kopi_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in KOPI_OVERLAYS
        overlay = KOPI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify kopi doctor recognizes Xiaomi env vars."""
