 ...
 *
 * Plugins call window.__KOPI_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__KOPI_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__KOPI_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__KOPI_PLUGIN_SDK__ = {
    ...
    // window.__KOPI_SESSION_TOKEN__ directly.
    authedFetch,
