"""Tests for the interactive session browser (`kopi sessions browse`).
...
from kopi_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """kopi sessions browse should be parseable."""
