import { type ScrollBoxHandle, useApp, useHasSelection, useSelection, useStdout, useTerminalTitle } from '@kopi/ink'
...
export function useMainApp(gw: GatewayClient) {
  ...
  const cwd = ui.info?.cwd || process.env.KOPI_CWD || process.cwd()
