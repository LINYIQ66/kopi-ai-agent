...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to KOPI AI AGENT — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to KOPI AI AGENT! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- **Profile-safe paths**: Never hardcode `~/.kopi` — use `get_kopi_home()` from `kopi_constants` for code paths and `display_kopi_home()` for user-facing messages. See [AGENTS.md](https://github.com/LINYIQ66/kopi-ai-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/LINYIQ66/kopi-ai-agent/blob/main/LICENSE).
