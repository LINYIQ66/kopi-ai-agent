...
| | |
|---|---|
| Source | Optional — install with `kopi skills install official/software-development/rest-graphql-debug` |
...
- Never hardcode tokens in scripts. Read from env (`os.environ["API_TOKEN"]`) or `${KOPI_HOME:-~/.kopi}/.env`.
