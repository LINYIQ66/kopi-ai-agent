...
# Ensure KOPI_HOME is set for imports that touch it at module level.
os.environ.setdefault("KOPI_HOME", os.path.join(os.path.expanduser("~"), ".kopi"))

from kopi_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "kopi-ai-agent repo",
            "docs": "https://kopi-ai-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
