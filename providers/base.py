...
def _profile_user_agent() -> str:
    """Return a ``kopi-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from kopi_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"kopi-cli/{_ver}"
    except Exception:
        return "kopi-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # kopi-cli UA so the catalog endpoint is reachable.
