...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.kopi/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at kopi_state import time, before pytest's KOPI_HOME monkeypatch
    fires — the autouse fixture's KOPI_HOME override doesn't help here.)
    """
    import kopi_state
