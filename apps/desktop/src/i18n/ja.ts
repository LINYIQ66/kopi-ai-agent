...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        '保存された設定を使用するには KOPI_DESKTOP_REMOTE_URL と KOPI_DESKTOP_REMOTE_TOKEN の設定を解除してください。',
      ...
      remoteUrlDesc:
        'リモートダッシュボードバックエンドのベース URL。/kopi などのパスプレフィックスもサポートしています。',
  ...
  skills: {
    ...
    skillArchivedMessage: 'kopi curator restore で復元できます。'
  },
  ...
  install: {
    ...
    settingUpTitle: 'KOPI AI AGENT を設定中',
    finishingTitle: '仕上げ中',
    failedDesc:
  ...
  onboarding: {
    headerTitle: 'KOPI AI AGENT のセットアップをしましょう',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `これにより "${pattern}" パターンが永続的な許可リスト (~/.kopi/config.yaml) に追加されます。Hermes はこのセッションや将来のセッションで、このようなコマンドについて再度尋ねません。`,
      alwaysAllow: '常に許可'
    },
    clarify: {
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'ゲートウェイの待機がタイムアウトしました。`kopi gateway` は起動していますか？'
    }
  },
