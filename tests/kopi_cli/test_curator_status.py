"""Tests for `kopi curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import kopi_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated KOPI_HOME with real agent-created skills on disk."""
    home = tmp_path / ".kopi"
    skills = home / "skills"
    ...
    from kopi_cli import curator as curator_cli
