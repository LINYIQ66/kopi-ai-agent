...
The unit tests in tests/kopi_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned kopi-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/kopi")
from kopi_cli.service_manager import S6ServiceManager
