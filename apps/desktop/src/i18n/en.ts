...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /kopi.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via kopi curator restore.',
    hub: {
  ...
  install: {
    ...
    settingUpTitle: 'Setting up KOPI AI AGENT',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with KOPI AI AGENT",
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.kopi/config.yaml). Hermes won’t ask again for commands like this — in this session or any future one.`,
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `kopi gateway` running?'
    }
  },
