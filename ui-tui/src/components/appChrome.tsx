import { Box, type ScrollBoxHandle, stringWidth, Text } from '@kopi/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (KOPI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (KOPI_DEV_CREDITS), lowest priority,
