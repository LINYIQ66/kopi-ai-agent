...
2. **Plugin tools** — `kopi_cli.plugins.discover_plugins()` loads user/project/pip plugins that may register additional tools.
...
- platform presets (`kopi-cli`, `kopi-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `kopi-acp`
