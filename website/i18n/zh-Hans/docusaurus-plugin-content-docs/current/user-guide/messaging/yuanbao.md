...
sidebar_position: 16
title: "Yuanbao"
description: "通过 WebSocket gateway 将 KOPI AI AGENT 连接到元宝企业消息平台"
---
...
3. 确保机器人账号拥有适当权限
4. 查看 gateway 日志：`tail -f ~/.kopi/logs/gateway.log`
...
2. 在连接设置中增加心跳超时时间
3. 确保到元宝 API 的网络连接稳定
4. 考虑启用详细日志：`KOPI_LOG_LEVEL=debug`
