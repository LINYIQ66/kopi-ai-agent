...
import type { ScrollBoxHandle } from '@kopi/ink'
import { evictInkCaches } from '@kopi/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.KOPI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
