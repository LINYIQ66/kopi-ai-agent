...
```
KOPI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("KOPI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `kopi_cli/config.py` | 1 | +streaming config defaults |
