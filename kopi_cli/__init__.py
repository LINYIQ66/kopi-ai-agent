...
- kopi gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `kopi setup` on a fresh Pi.
    ...
    kopi_cli/stdio.py::configure_windows_stdio() runs later from the entry
