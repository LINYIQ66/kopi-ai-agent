...
sidebar_position: 6
title: "Signal"
description: "通过 signal-cli 守护进程将 KOPI AI AGENT 设置为 Signal 机器人"
---
...
sudo kopi gateway install --system   # 仅 Linux：开机自启系统服务
```
...
2. **未设置白名单** → 未知用户会收到私信配对码（通过 `kopi pairing approve signal CODE` 审批）
