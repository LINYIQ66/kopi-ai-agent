...
export const en: Translations = {
  ...
  status: {
    ...
    updateHermesConfirmMessage:
      "This runs kopi update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Hermes plugins (`kopi plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.kopi/plugins/?",
    removeHint: "Only user-installed plugins under ~/.kopi/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.kopi/skills/",
