"""ACP tool-call helpers for mapping kopi tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map kopi tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a kopi tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    *,
    ...
    """Create a ToolCallStart event for the given kopi tool invocation."""
