...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Hermes (паритет з `kopi plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.kopi/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.kopi/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.kopi/skills/",
