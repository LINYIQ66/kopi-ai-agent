...
sidebar_position: 7
title: "Email"
description: "Set up KOPI AI AGENT as an email assistant via IMAP/SMTP"
---
...
| **Duplicate replies** | Ensure only one gateway instance is running. Check `kopi gateway status`. |
...
- The password is stored in `~/.kopi/.env` — protect this file (`chmod 600`)
