...
import { disconnectOAuthProvider, listOAuthProviders } from '@/kopi'
...
const canRunInTerminal = () => typeof window !== 'undefined' && Boolean(window.kopiDesktop?.terminal)
...
//      in kopi_cli/provider_catalog.py) — the SAME provider identity
//      `kopi model` uses. This is authoritative: a provider tagged by the
