"""Tests for _setup_feishu() in kopi_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("kopi_cli.config.save_env_value", side_effect=mock_save), \
         patch("kopi_cli.config.get_env_value", side_effect=mock_get), \
         patch("kopi_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("kopi_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("kopi_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("kopi_cli.cli_output.print_header"), \
         patch("kopi_cli.cli_output.print_info"), \
         patch("kopi_cli.cli_output.print_success"), \
         patch("kopi_cli.cli_output.print_warning"), \
         patch("kopi_cli.cli_output.print_error"), \
