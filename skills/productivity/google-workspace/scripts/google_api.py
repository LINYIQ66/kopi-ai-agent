#!/usr/bin/env python3
"""Google Workspace API CLI for KOPI AI AGENT.
...
from _kopi_home import get_kopi_home
...
def _gws_binary() -> str | None:
    override = os.getenv("KOPI_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for KOPI AI AGENT")
