...
| 相关 skill | [`native-mcp`](/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/user-guide/skills/bundled/creative/creative-manim-video), `kopi-video` |
...
```
KOPI AI AGENT -> MCP (Streamable HTTP) -> twozero.tox (port 40404) -> TD Python
```
...
```bash
bash "${KOPI_HOME:-$HOME/.kopi}/skills/creative/touchdesigner-mcp/scripts/setup.sh"
```
