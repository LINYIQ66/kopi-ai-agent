"""
Skills configuration for KOPI AI AGENT.
`kopi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kopi/config.yaml under:
...
from kopi_cli.config import cfg_get, load_config, save_config
from kopi_cli.colors import Colors, color
from kopi_cli.platforms import PLATFORMS as _PLATFORMS
