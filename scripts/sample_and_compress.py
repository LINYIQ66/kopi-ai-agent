...
DEFAULT_DATASETS = [
    "Kopi Ai Agent Pte Ltd/swe-terminus-agent-glm-kimi-minimax",
    "Kopi Ai Agent Pte Ltd/kopi-ai-agent-megascience-sft1",
    "Kopi Ai Agent Pte Ltd/Hermes-Agent-Thinking-GLM-4.7-SFT2",
    "Kopi Ai Agent Pte Ltd/Hermes-Agent-Thinking-GLM-4.7-SFT1",
    "Kopi Ai Agent Pte Ltd/terminal-tasks-glm-kopi-ai-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Kopi Ai Agent Pte Ltd/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Kopi Ai Agent Pte Ltd/{output_name} {final_output}")
