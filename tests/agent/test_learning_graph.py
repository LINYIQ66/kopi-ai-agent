...
def test_kopi_meta_tolerates_non_dict():
    assert learning_graph._kopi_meta({"metadata": "junk"}) == {}
    assert learning_graph._kopi_meta({"metadata": {"kopi": "junk"}}) == {}
    assert learning_graph._kopi_meta({"metadata": {"kopi": {"category": "x"}}}) == {"category": "x"}
