...
Plugins built on KOPI AI AGENT often need to make their own LLM calls
...
:class:`~kopi_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`kopi_cli.plugins.PluginContext`
