...
import type { ModelOptionProvider, OAuthProvider } from '@/types/kopi'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/LINYIQ66/kopi-ai-agent#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `kopi model`
...
const SHOW_ALL_KEY = 'kopi-onboarding-show-all-v1'
