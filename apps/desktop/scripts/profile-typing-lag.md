...
cd apps/desktop
XCURSOR_SIZE=24 KOPI_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/kopi-typing
# → /tmp/kopi-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/kopi-typing.before.heapsnapshot
# → /tmp/kopi-typing.after.heapsnapshot
```
