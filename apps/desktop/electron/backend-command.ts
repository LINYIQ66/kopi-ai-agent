...
// app hasn't updated yet, or an older `kopi` resolved from PATH) only knows
 ...
 * `-m kopi_cli.main` and any `--profile <name>`). Returns a copy; if there is
...
/**
 * True when a runtime's `kopi_cli/subcommands/dashboard.py` source registers
