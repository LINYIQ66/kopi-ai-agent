...
export const de: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Hermes-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `kopi plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.kopi/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.kopi/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.kopi/skills/ geladen",
