...
Invoked by ``kopi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the KOPI AI AGENT board.
...
def _profile_author() -> str:
    """Mirror of ``kopi_cli.kanban._profile_author``."""
    return (
