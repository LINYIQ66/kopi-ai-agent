"""Tests for the ``kopi prompt-size`` diagnostic (issue #34667)."""
...
from kopi_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(kopi_home, memory_text="", user_text=""):
    mem_dir = kopi_home / "memories"
...
def _seed_skill(kopi_home, name, description):
    skill_dir = kopi_home / "skills" / "demo" / name
