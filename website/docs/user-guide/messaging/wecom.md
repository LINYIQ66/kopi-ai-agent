...
description: "Connect KOPI AI AGENT to WeCom via the AI Bot WebSocket gateway"
---
...
5. Run `kopi gateway setup`, select **WeCom**, and enter the credentials when prompted
