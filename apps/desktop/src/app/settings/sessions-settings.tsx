...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/kopi'
...
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.kopiDesktop` is
    ...
    const settings = window.kopiDesktop?.settings
