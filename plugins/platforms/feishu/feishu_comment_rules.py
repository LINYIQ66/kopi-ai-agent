...
Config: ~/.kopi/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kopi/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kopi_home()`` helper (KOPI_HOME-aware and
...
RULES_FILE = get_kopi_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kopi_home() / "feishu_comment_pairing.json"
