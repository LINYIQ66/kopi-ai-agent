...
- persisted runtime files:
  - `~/.kopi/plugins/kopi-achievements/state.json` (existing unlock state)
  - `~/.kopi/plugins/kopi-achievements/scan_snapshot.json` (new)
  - `~/.kopi/plugins/kopi-achievements/scan_checkpoint.json` (new)
