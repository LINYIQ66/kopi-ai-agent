...
export const pt: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Hermes (paridade com `kopi plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.kopi/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.kopi/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.kopi/skills/",
