...
Skins are defined as YAML files in ~/.kopi/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "KOPI AI AGENT"          # Banner title, status display
...
.. code-block:: python
    ...
    from kopi_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "KOPI AI AGENT"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.kopi/skins/
...
Drop a YAML file in ``~/.kopi/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces KOPI_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces KOPI_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to KOPI AI AGENT! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
