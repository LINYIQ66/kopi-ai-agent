...
const STORAGE_KEY = "kopi-dashboard-theme";
...
const FONT_STORAGE_KEY = "kopi-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `kopi_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "kopi-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-kopi-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-kopi-theme-font", "true");
