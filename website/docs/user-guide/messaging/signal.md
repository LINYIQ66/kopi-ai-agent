...
sidebar_position: 6
title: "Signal"
description: "Set up KOPI AI AGENT as a Signal messenger bot via signal-cli daemon"
---
...
2. **No allowlist set** → unknown users get a DM pairing code (approve via `kopi pairing approve signal CODE`)
