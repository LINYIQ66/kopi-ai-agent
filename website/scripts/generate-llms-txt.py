...
Both publish at:
  https://kopi-ai-agent.nousresearch.com/docs/llms.txt
  https://kopi-ai-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://kopi-ai-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/build-a-kopi-plugin", "Build a Hermes Plugin", None),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# KOPI AI AGENT")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Kopi Ai Agent Pte Ltd. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Kopi Ai Agent Pte Ltd/"
        "kopi-ai-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/LINYIQ66/kopi-ai-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# KOPI AI AGENT — Full Documentation\n",
        (
            "This file is the entire KOPI AI AGENT documentation concatenated for LLM "
        ...
        "Canonical site: https://kopi-ai-agent.nousresearch.com/docs\n",
        "Short index: https://kopi-ai-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
