...
| | |
|---|---|
| Source | Optional — install with `kopi skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | KOPI AI AGENT (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $KOPI_OSINT_CACHE/icij/ (default: ~/.cache/kopi-osint/icij/).
...
# Set KOPI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
