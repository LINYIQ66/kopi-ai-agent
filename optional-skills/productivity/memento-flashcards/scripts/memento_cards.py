...
Data file: $KOPI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KOPI_HOME = Path(os.environ.get("KOPI_HOME", Path.home() / ".kopi"))
DATA_DIR = _KOPI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
