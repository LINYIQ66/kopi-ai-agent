...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов Hermes (аналог `kopi plugins`).",
    ...
    removeConfirm: "Удалить этот плагин из ~/.kopi/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.kopi/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.kopi/skills/",
