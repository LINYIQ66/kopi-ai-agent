...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        spawn_env = kopi_subprocess_env(inherit_credentials=True)
        if env:
        ...
        if spawn_env.get("KOPI_KANBAN_TASK"):
            kanban_db = spawn_env.get("KOPI_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "KOPI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("KOPI_HOME", os.path.expanduser("~/.kopi")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "kopi",
        client_title: str = "KOPI AI AGENT",
