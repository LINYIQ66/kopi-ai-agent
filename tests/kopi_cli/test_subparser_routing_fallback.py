...
The main() function in kopi_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `kopi -c model`
...
def _build_parser():
    """Build a minimal replica of the kopi top-level parser."""
