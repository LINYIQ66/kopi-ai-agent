...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`kopi-ai-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kopi-ai-agent) |
...
```bash
TASK_ID="${KOPI_KANBAN_TASK:-t_manual}"
REPO="/path/to/repo"
...
- [ ] Hermes ran the canonical tests itself, using `scripts/run_tests.sh` for KOPI AI AGENT or the repo's documented wrapper for other repos.
