"""Tests for IRC gateway configuration via `kopi setup gateway` UI.
...
class TestIRCFreshInstallDiscovery:
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#kopi")
            monkeypatch.setenv("IRC_NICKNAME", "kopi-bot")
...
class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `kopi setup gateway` experience with IRC present."""
