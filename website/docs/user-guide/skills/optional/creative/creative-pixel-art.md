...
| | |
|---|---|
| Source | Optional — install with `kopi skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.kopi/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.kopi/skills/creative/pixel-art/scripts
