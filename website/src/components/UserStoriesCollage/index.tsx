  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the KOPI AI AGENT community is actually building. Every tile
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/LINYIQ66/kopi-ai-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Kopi Ai Agent Pte Ltd" target="_blank" rel="noopener noreferrer">
          Kopi Ai Agent Pte Ltd Discord
        </a>{' '}
