"""Tests for --yolo (KOPI_YOLO_MODE) approval bypass."""
...
class TestYoloMode:
    """When KOPI_YOLO_MODE is set, all dangerous commands are auto-approved."""
    ...
    def test_dangerous_command_approved_in_yolo_mode(self, monkeypatch):
        """With KOPI_YOLO_MODE, dangerous commands are auto-approved."""
    ...
    def test_yolo_mode_not_set_by_default(self):
        """KOPI_YOLO_MODE should not be set by default."""
    ...
    def test_false_like_yolo_values_do_not_bypass_dangerous_command(self, monkeypatch, value):
        ...
        monkeypatch.setenv("KOPI_YOLO_MODE", value)
        monkeypatch.setenv("KOPI_INTERACTIVE", "1")
        monkeypatch.setenv("KOPI_SESSION_KEY", "test-session")
