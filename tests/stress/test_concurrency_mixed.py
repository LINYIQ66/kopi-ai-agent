...
def worker_loop(worker_id: int, kopi_home: str, result_file: str) -> None:
...
def reclaimer_loop(kopi_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="kopi_mixed_stress_")
    print(f"KOPI_HOME = {home}")
