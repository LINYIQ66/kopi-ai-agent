...
export const fr: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Hermes (parité avec `kopi plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.kopi/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.kopi/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.kopi/skills/",
