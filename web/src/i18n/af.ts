...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Hermes-inproppe op (`kopi plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.kopi/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.kopi/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.kopi/skills/",
