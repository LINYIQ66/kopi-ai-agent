...
| | |
|---|---|
| Source | Optional — install with `kopi skills install official/gaming/pokemon-player` |
...
The repo is Kopi Ai Agent Pte Ltd/pokemon-agent on GitHub. Clone it, then
