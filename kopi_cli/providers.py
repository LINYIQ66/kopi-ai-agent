"""
Single source of truth for provider identity in KOPI AI AGENT.
...
KOPI_OVERLAYS: Dict[str, HermesOverlay] = {
    "moa": HermesOverlay(
    ...
    "qwen-oauth": HermesOverlay(
        ...
        base_url_env_var="KOPI_QWEN_BASE_URL",
    ),
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "kopi", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = KOPI_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + kopi extra
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in KOPI_OVERLAYS
    if provider == "bedrock":
