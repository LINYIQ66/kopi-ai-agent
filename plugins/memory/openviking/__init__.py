...
_SYNC_TRACE_ENV = "KOPI_OPENVIKING_SYNC_TRACE"
...
def _load_kopi_openviking_config() -> dict:
    try:
...
def _openviking_server_log_path() -> Path:
    try:
        ...
        home = Path(os.environ.get("KOPI_HOME", "")).expanduser() if os.environ.get("KOPI_HOME") else Path.home() / ".kopi"
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # against a concurrent increment. See kopi-ai-agent#28296 review.
    ...
    def is_available(self) -> bool:
        ...
        if os.environ.get("OPENVIKING_ENDPOINT"):
            return True
        provider_config = _load_kopi_openviking_config()
    ...
    def post_setup(self, kopi_home: str, config: dict) -> None:
        ...
        from kopi_cli.memory_setup import _CANCELLED, _curses_select, _print_cancelled_setup, _prompt

        kopi_home_path = Path(kopi_home)
        env_path = kopi_home_path / ".env"
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        settings = _resolve_connection_settings(_load_kopi_openviking_config())
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        and memory extraction never fires for it. See kopi-ai-agent#28296.
    ...
    def _read_uri_payload(
        ...
        *,
        ...
        # (e.g. viking://user/kopi/.overview.md).
