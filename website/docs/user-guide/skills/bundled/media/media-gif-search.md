...
Set your Tenor API key in your environment (add to `${KOPI_HOME:-~/.kopi}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/LINYIQ66/kopi-ai-agent/blob/main/skills/media/gif-search/url)`
