...
``is_nous_kopi_non_agentic`` should only match the actual Kopi Ai Agent Pte Ltd
...
@pytest.mark.parametrize(
    "model_name",
    [
        "Kopi Ai Agent Pte Ltd/Hermes-3-Llama-3.1-70B",
        "Kopi Ai Agent Pte Ltd/Hermes-3-Llama-3.1-405B",
        "kopi-3",
        "Hermes-3",
        "kopi-4",
        "kopi-4-405b",
