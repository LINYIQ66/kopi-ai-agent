...
await build({
  ...
  // Skip the prebuilt @kopi/ink bundle and inline the source instead:
  ...
  alias: { '@kopi/ink': resolve(root, 'packages/hermes-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The kopi_cli launcher
