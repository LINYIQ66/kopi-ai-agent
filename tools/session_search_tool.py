...
the get_anchored_view / get_messages_around primitives in kopi_state.
...
# Third-party integrations tag their sessions with KOPI_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from kopi_state import DEFAULT_DB_PATH
