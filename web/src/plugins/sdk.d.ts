 ...
 * ====================================================
 *
 * This is the public type surface for ``window.__KOPI_PLUGIN_SDK__`` and
 * ``window.__KOPI_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__KOPI_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@kopi/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__KOPI_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__KOPI_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__KOPI_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __KOPI_PLUGIN_SDK__?: HermesPluginSDK;
    __KOPI_PLUGINS__?: PluginRegistry;
  }
}
