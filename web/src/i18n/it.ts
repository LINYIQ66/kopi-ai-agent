...
export const it: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Hermes (parità con `kopi plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.kopi/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.kopi/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.kopi/skills/",
