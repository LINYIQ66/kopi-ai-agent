...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc: '取消設定 KOPI_DESKTOP_REMOTE_URL 和 KOPI_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
  ...
  skills: {
    ...
    skillArchivedMessage: '可透過 kopi curator restore 還原。'
  },
  ...
  install: {
    ...
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 KOPI AI AGENT',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  onboarding: {
    headerTitle: '開始設定 KOPI AI AGENT',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.kopi/config.yaml）。Hermes 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`kopi gateway` 是否正在執行？'
    }
  },
