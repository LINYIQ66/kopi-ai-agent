...
export const ja: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Hermes プラグインを発見、インストール、有効化、更新します (`kopi plugins` 相当)。",
    ...
    removeConfirm: "このプラグインを ~/.kopi/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.kopi/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.kopi/skills/ から読み込まれます",
