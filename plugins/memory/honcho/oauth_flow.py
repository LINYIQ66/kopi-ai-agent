...
_DEFAULT_CLIENT_ID = "kopi-ai-agent"
...
def begin_authorization(
    ...
    *,
    ...
    (``kopi-desktop`` / ``kopi-cli``) so the consent side can attribute
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local KOPI_HOME override can't reach.
