...
Configuration
-------------
Secret (lives in $KOPI_HOME/.env or the environment):
...
Behavioral settings (live in $KOPI_HOME/mem0.json, set via `kopi memory
setup`):
...
def _load_config() -> dict:
    """Load config from env vars, with $KOPI_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "kopi"),
        "oss": {},
    }
    ...
    config_path = get_kopi_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, kopi_home):
        """Write config to $KOPI_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $KOPI_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "kopi")
